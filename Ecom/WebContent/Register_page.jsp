...
<body>
        ...
        <form action="Register" >
            <div class="user_details">
                ...
                <div class="input_pox">
                    ...
                    <input type="text" name = "PhoneNumber" placeholder="enter your Phone" required>
                </div>
                <div class="input_pox">
    ...
    <input type="radio" name="gender" id="dot-3" value="transgender1">
                ...
                <div class="category">
                    ...
                    <label for="dot-3">
                        ...
                        <span class="gender">Pefer not to say</span>
                    </label>
                </div>
            </div>
            <div class="button">
