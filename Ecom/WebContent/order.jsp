...
<form action="Done">
    ...
    <a href="Checkdelivery">Check Address</a>
<figure>
	...
	<br/><br>
	Address 1 <input type="text" placeholder="enter your address" required name="address1">
	<br/><br/>
	Address 2 <input type ="text" name ="address2" required>
	<br/><br/>
	Landmark  <input type ="text" name = "landmark"required>
	<br/><br/>
